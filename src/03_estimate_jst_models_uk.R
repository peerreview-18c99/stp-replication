...
input <- input %>% 
  tidylog::mutate(dfm_file = paste0("data/parlspeech dfms/dfm_parlspeech_", 
                                    ...
                                    ".rds"))
input <- input %>% 
  tidylog::mutate(dictionary_file = case_when(dictionary == "LIWC" ~ "data/dictionaries/dict_liwc_en.rds",
                                              dictionary == "LSD" ~ "data/dictionaries/dict_lsd_en.rds",
                                              dictionary == "Rheault" ~ "data/dictionaries/dict_rheault_en.rds"))
...
# Save results
write_rds(jst_results, file = "data/jst_results_uk.rds", compress = "xz")
